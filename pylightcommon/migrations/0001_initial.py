...
import PyLightSupport.pylightcommon.models
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ioType', models.CharField(choices=[(PyLightSupport.pylightcommon.models.EnumIOType('IOType.NONE'), 'IOType.NONE'), (PyLightSupport.pylightcommon.models.EnumIOType('IOType.OUTPUT'), 'IOType.OUTPUT'), (PyLightSupport.pylightcommon.models.EnumIOType('IOType.INPUT'), 'IOType.INPUT')], max_length=255, verbose_name='Type of output')),
            ],
        ),
        migrations.CreateModel(
            name='UsedIO',
